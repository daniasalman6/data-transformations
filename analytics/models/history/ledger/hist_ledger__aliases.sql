...
SELECT
    ...
    toLowCardinality(JSONExtractString(_airbyte_data, 'alias_type')) AS alias_type,
    JSONExtractBool(_airbyte_data, 'active') AS active,
    ...
    _airbyte_data
FROM {{ source('airbyte_tables', '_airbyte_raw_aliases') }}
