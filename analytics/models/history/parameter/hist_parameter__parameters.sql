...
SELECT
    ...
    JSONExtractString(_airbyte_data, 'namespace') AS namespace,
    toLowCardinality(JSONExtractString(_airbyte_data, 'language')) AS language,
    ...
    _airbyte_data
FROM {{ source('airbyte_tables', '_airbyte_raw_parameters') }}
