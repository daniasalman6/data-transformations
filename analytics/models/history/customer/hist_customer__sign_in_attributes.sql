...
SELECT
    ...
    JSONExtract(_airbyte_data, 'unverified_customer_id', 'UUID') AS unverified_customer_id,
    ...
    JSONExtractBool(_airbyte_data, 'verified') AS verified,
    ...
    _airbyte_data
FROM {{ source('airbyte_tables', '_airbyte_raw_sign_in_attributes') }}
